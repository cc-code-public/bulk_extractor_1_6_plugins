...
{STARTP}{BLOCKP} {
    ...
    if(check_base58(yytext,yyleng)){
        s.bitcoin_recorder->write_buf(SBUF,s.pos,yyleng);
    }    
    s.pos += yyleng;
